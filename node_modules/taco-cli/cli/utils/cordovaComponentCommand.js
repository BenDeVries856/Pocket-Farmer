 ...
 */
var CordovaComponentCommand = (function (_super) {
    __extends(CordovaComponentCommand, _super);
    function CordovaComponentCommand() {
        _super.apply(this, arguments);
    }
    Object.defineProperty(CordovaComponentCommand.prototype, "knownOptions", {
        get: function () {
    ...
    Object.defineProperty(CordovaComponentCommand.prototype, "knownSubCommands", {
        get: function () {
            throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
        },
        enumerable: true,
    ...
    Object.defineProperty(CordovaComponentCommand.prototype, "knownTargetsSubCommands", {
        get: function () {
            throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
        },
        enumerable: true,
    ...
    Object.defineProperty(CordovaComponentCommand.prototype, "shortFlags", {
        get: function () {
            throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
        },
        enumerable: true,
     ...
     */
    CordovaComponentCommand.prototype.runCordovaCommand = function (targets) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     * Reads config.xml and returns the version overrides for a given target
     */
    CordovaComponentCommand.prototype.getConfigXmlVersionSpec = function (targetName, projectInfo) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     * Edits the version override info to config.xml of the cordova project
     */
    CordovaComponentCommand.prototype.editVersionOverrideInfo = function (componentInfo, projectInfo) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     ...
     */
    CordovaComponentCommand.prototype.getKitOverride = function (targetName, kitId) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     * returns command options for a kit component command
     */
    CordovaComponentCommand.prototype.getCommandOptions = function (commandData) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     * Given bunch of targets getting added/removed prints a success message on the screen
     */
    CordovaComponentCommand.prototype.printSuccessMessage = function (targets) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     * Given bunch of targets getting added/removed prints a progress message on the screen
     */
    CordovaComponentCommand.prototype.printInProgressMessage = function (targets) {
        throw errorHelper.get(TacoErrorCodes.UnimplementedAbstractMethod);
    };
    /**
     * specific handling for whether this command can handle the args given, otherwise falls through to Cordova CLI
     */
    CordovaComponentCommand.prototype.canHandleArgs = function (data) {
        return true;
    };
    /**
     * Parse the arguments and construct the command parameters.
     */
    CordovaComponentCommand.prototype.parseArgs = function (args) {
     ...
     */
    CordovaComponentCommand.prototype.add = function () {
     ...
     */
    CordovaComponentCommand.prototype.passthrough = function () {
        var commandData = this.data;
        var self = this;
     ...
     */
    CordovaComponentCommand.prototype.applyKitOverridesIfApplicable = function (projectInfo) {
        var commandData = this.data;
        var self = this;
    ...
    CordovaComponentCommand.prototype.getCordovaComponentInfo = function (targetId, projectInfo) {
        var self = this;
    ...
    CordovaComponentCommand.makeCordovaComponentInfo = function (targetName, version, src) {
        if (version) {
     ...
     */
    CordovaComponentCommand.prototype.generateTelemetryProperties = function (targets) {
        var commandData = this.data;
        if (!targets) {
    ...
    CordovaComponentCommand.prototype.isTargetVersionOverridden = function (targetId, projectInfo) {
    ...
    CordovaComponentCommand.getTargetsForStatus = function (targets) {
    ...
    return CordovaComponentCommand;
}(commands.TacoCommandBase));
exports.CordovaComponentCommand = CordovaComponentCommand;

//# sourceMappingURL=cordovaComponentCommand.js.map
